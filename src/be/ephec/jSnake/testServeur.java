...
/**
 * 
 * Cette classe d�finis le joueur "serveur", c'est � dire, celui qui sera l'h�te du jeu
 * auquel le second joueur qualifi� de client se connectera pour jouer en r�seau au jeu.
 *
 */
